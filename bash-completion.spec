...
Source0  : https://github.com/scop/bash-completion/releases/download/2.14.0/bash-completion-2.14.0.tar.xz
...
%prep
%setup -q -n bash-completion-2.14.0
cd %{_builddir}/bash-completion-2.14.0
%patch -P 1 -p1
pushd ..
cp -a bash-completion-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743175029
...
cp %{_builddir}/bash-completion-%{version}/COPYING %{buildroot}/usr/share/package-licenses/bash-completion/4cc77b90af91e615a64ae04893fdffa7939db84c || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
rm -f %{buildroot}*/usr/share/bash-completion/completions/secret-tool
...
/usr/share/cmake/*
/usr/share/defaults/etc/bash_completion.d/000_bash_completion_compat.bash
...
/usr/share/package-licenses/bash-completion/4cc77b90af91e615a64ae04893fdffa7939db84c
