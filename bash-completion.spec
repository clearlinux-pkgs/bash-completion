...
Source0  : https://github.com/scop/bash-completion/releases/download/2.13.0/bash-completion-2.13.0.tar.xz
...
%prep
%setup -q -n bash-completion-2.13.0
cd %{_builddir}/bash-completion-2.13.0
%patch -P 1 -p1
pushd ..
cp -a bash-completion-2.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712239508
